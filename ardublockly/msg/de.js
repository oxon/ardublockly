...
Ardublockly.LOCALISED_TEXT = {
  ...
  noServerBody: "<p>Damit du die Karte aus dem Browser direkt programmieren kannst, musst du die OXOcard-App starten. Hast du sie noch nicht installiert, so kannst du die Installationsdatei unter folgendem Link herunterladen:</p> <p><a href=\"http:\/\/www.oxocard.ch/Arduino/Downloads/OxocardAgent-Installer.dmg\" target=\"_blank\" rel=\"noopener\">OXOcard-App Installationsdatei Mac OSX</a></p> <p>Windows Installer (folgt in kürze)</p><p>Starte danach den Browser neu und stecke die OXOcard an einen freien USB-Port.<br>Falls es nicht funktioniert, hilft häufig folgendes:</p> <ul><li>- Starte den Computer neu</li><li>- Versuche, die OXOcard an einem anderen USB-Anschluss einzustecken</li><li>- Stell sicher, dass nur ein Browserfenster mit Blockly offen ist</li><li>- Beende alle Programme, die automatisch die serielle Schnittstelle nutzen, wie z.B. MakerWare</li></ul>",
