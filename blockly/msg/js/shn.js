...
Blockly.Msg.MATH_CHANGE_TITLE = "Increment %1 by %2";  // untranslated
...
Blockly.Msg.MATH_DECREMENT_HELPURL = "https://en.wikipedia.org/wiki/Programming_idiom#Incrementing_a_counter";  // untranslated
Blockly.Msg.MATH_DECREMENT_TITLE = "Decrement %1 by %2";  // untranslated
Blockly.Msg.MATH_DECREMENT_TOOLTIP = "Subtract a number from variable '%1'.";  // untranslated
...
Blockly.Msg.ARD_FUN_RUN_TIP = "Defines the OXOcard setup() and loop() functions.";  // untranslated
...
Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIMEOUT_FIELD = "with timeout";  // untranslated
Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIP = "Enter sleep mode after given timeout";  // untranslated
Blockly.Msg.OXOCARD_AUTO_TURNOFF_TITLE = "Handle auto turnoff";  // untranslated
Blockly.Msg.OXOCARD_AUTO_TURNOFF_WP_TIP = "Enter sleep mode after 2 Minutes";  // untranslated
Blockly.Msg.OXOCARD_AUTO_TURNOFF_WP_TITLE = "Handle auto turnoff";  // untranslated
Blockly.Msg.OXOCARD_BUTTON_PRESSED_LEFT_FIELD = "Left";  // untranslated
Blockly.Msg.OXOCARD_BUTTON_PRESSED_MIDDLE_FIELD = "Middle";  // untranslated
Blockly.Msg.OXOCARD_BUTTON_PRESSED_RIGHT_FIELD = "Right";  // untranslated
Blockly.Msg.OXOCARD_BUTTON_PRESSED_TIP = "Yes(?) if button pressed";  // untranslated
Blockly.Msg.OXOCARD_BUTTON_PRESSED_TITLE = "Is button pressed?";  // untranslated
Blockly.Msg.OXOCARD_CLEAR_DISPLAY_TIP = "Turn the whole display off";  // untranslated
Blockly.Msg.OXOCARD_CLEAR_DISPLAY_TITLE = "Clear display";  // untranslated
Blockly.Msg.OXOCARD_DRAW_CHAR_TIP = "Draw single character (A - Z)";  // untranslated
Blockly.Msg.OXOCARD_DRAW_CHAR_TITLE = "Draw char";  // untranslated
Blockly.Msg.OXOCARD_DRAW_CIRCLE_TIP = "Draw a circle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_CIRCLE_TITLE = "Draw circle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_DIGIT_TIP = "Draw single digit (0 - 9)";  // untranslated
Blockly.Msg.OXOCARD_DRAW_DIGIT_TITLE = "Draw digit";  // untranslated
Blockly.Msg.OXOCARD_DRAW_FILLED_CIRCLE_TIP = "Draw a filled circle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_FILLED_CIRCLE_TITLE = "Draw filled circle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_FILLED_RECTANGLE_TIP = "Draw a filled rectangle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_FILLED_RECTANGLE_TITLE = "Draw filled rectangle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_FILLED_TRANGLE_TIP = "Draw a filled triangle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_FILLED_TRANGLE_TITLE = "Draw filled triangle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_IMAGE_BRIGHTNESS_FIELD = "Brightness:";  // untranslated
Blockly.Msg.OXOCARD_DRAW_IMAGE_TIP = "Turn on specific pixels";  // untranslated
Blockly.Msg.OXOCARD_DRAW_IMAGE_TITLE = "Draw image";  // untranslated
Blockly.Msg.OXOCARD_DRAW_LINE_TIP = "Draw a line";  // untranslated
Blockly.Msg.OXOCARD_DRAW_LINE_TITLE = "Draw line";  // untranslated
Blockly.Msg.OXOCARD_DRAW_NUMBER_TIP = "Draw a number (0 - 99)";  // untranslated
Blockly.Msg.OXOCARD_DRAW_NUMBER_TITLE = "Draw number";  // untranslated
Blockly.Msg.OXOCARD_DRAW_PIXEL_TIP = "Turn on specific pixels";  // untranslated
Blockly.Msg.OXOCARD_DRAW_PIXEL_TITLE = "Draw pixel";  // untranslated
Blockly.Msg.OXOCARD_DRAW_RECTANGLE_TIP = "Draw a rectangle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_RECTANGLE_TITLE = "Draw rectangle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_TRANGLE_TIP = "Draw a triangle";  // untranslated
Blockly.Msg.OXOCARD_DRAW_TRANGLE_TITLE = "Draw triangle";  // untranslated
Blockly.Msg.OXOCARD_FILL_DISPLAY_TIP = "Write value between 0 and 255";  // untranslated
Blockly.Msg.OXOCARD_FILL_DISPLAY_TITLE = "Fill display";  // untranslated
Blockly.Msg.OXOCARD_FIND_IBEACON_TIP = "Serach for iBeacons with the given ID";  // untranslated
Blockly.Msg.OXOCARD_FIND_IBEACON_TITLE = "Find iBeacon with the ID";  // untranslated
Blockly.Msg.OXOCARD_GET_ACCELERATION_TIP = "Return the selected accelerometer axis value";  // untranslated
Blockly.Msg.OXOCARD_GET_ACCELERATION_TITLE = "Get acceleration";  // untranslated
Blockly.Msg.OXOCARD_GET_ORIENTATION_TIP = "Return the orientation of the OXOcard";  // untranslated
Blockly.Msg.OXOCARD_GET_ORIENTATION_TITLE = "Get orientation";  // untranslated
Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TIP = "Return the seconds value uf the timer";  // untranslated
Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TITLE = "Get timer seconds";  // untranslated
Blockly.Msg.OXOCARD_IS_ORIENTATION_DOWN_FIELD = "Down";  // untranslated
Blockly.Msg.OXOCARD_IS_ORIENTATION_HORIZONTALLY_FIELD = "Horizontally";  // untranslated
Blockly.Msg.OXOCARD_IS_ORIENTATION_TIP = "Return if the OXOcard is in the given orientation";  // untranslated
Blockly.Msg.OXOCARD_IS_ORIENTATION_TITLE = "Is orientation";  // untranslated
Blockly.Msg.OXOCARD_IS_ORIENTATION_UP_FIELD = "Up";  // untranslated
Blockly.Msg.OXOCARD_IS_ORIENTATION_VERTICALLY_FIELD = "Vertically";  // untranslated
Blockly.Msg.OXOCARD_NO_TONE_TIP = "Stops the tone";  // untranslated
Blockly.Msg.OXOCARD_NO_TONE_TITLE = "No tone";  // untranslated
Blockly.Msg.OXOCARD_PRINTLN_TIP = "Prints the given number or string to the console (with new line)";  // untranslated
Blockly.Msg.OXOCARD_PRINTLN_TITLE = "Println";  // untranslated
Blockly.Msg.OXOCARD_PRINT_TIP = "Prints the given number or string to the console";  // untranslated
Blockly.Msg.OXOCARD_PRINT_TITLE = "Print";  // untranslated
Blockly.Msg.OXOCARD_RANDOM_TIP = "Returns a random number between 0 an the given value";  // untranslated
Blockly.Msg.OXOCARD_RANDOM_TITLE = "Random 0 to ";  // untranslated
Blockly.Msg.OXOCARD_RESET_OXOCARD_TIP = "Reboots the card";  // untranslated
Blockly.Msg.OXOCARD_RESET_OXOCARD_TITLE = "Reset OXOcard";  // untranslated
Blockly.Msg.OXOCARD_RESET_TIMER_TIP = "Resets the timer";  // untranslated
Blockly.Msg.OXOCARD_RESET_TIMER_TITLE = "Reset timer";  // untranslated
Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_ID_FIELD = "With the ID";  // untranslated
Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_TIP = "Sets the OXOcard up as iBeacon with the given ID";  // untranslated
Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_TITLE = "Setup the OXOcard as iBeacon";  // untranslated
Blockly.Msg.OXOCARD_SMILE_TIP = "A simple smile :)";  // untranslated
Blockly.Msg.OXOCARD_SMILE_TITLE = "Draw smile";  // untranslated
Blockly.Msg.OXOCARD_TONE_DURATION_FIELD = "for the duration";  // untranslated
Blockly.Msg.OXOCARD_TONE_FREQUENCY_FIELD = "with frequency";  // untranslated
Blockly.Msg.OXOCARD_TONE_NO_DURATION_TIP = "Plays a tone";  // untranslated
Blockly.Msg.OXOCARD_TONE_NO_DURATION_TITLE = "Play tone";  // untranslated
Blockly.Msg.OXOCARD_TONE_TIP = "Plays a tone for the givern time";  // untranslated
Blockly.Msg.OXOCARD_TONE_TITLE = "Play tone";  // untranslated
Blockly.Msg.OXOCARD_TURN_DISPLAY_ON_TIP = "Turn the whole display on";  // untranslated
Blockly.Msg.OXOCARD_TURN_DISPLAY_ON_TITLE = "Turn display on";  // untranslated
Blockly.Msg.OXOCARD_TURN_OXOCARD_OFF_TIP = "Turns off the card";  // untranslated
Blockly.Msg.OXOCARD_TURN_OXOCARD_OFF_TITLE = "Turn OXOcard off";  // untranslated
Blockly.Msg.OXOCARD_WINK_TIP = "A simple wink ;)";  // untranslated
Blockly.Msg.OXOCARD_WINK_TITLE = "Draw wink";  // untranslated
