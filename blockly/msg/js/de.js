...
Blockly.Msg.MATH_DECREMENT_HELPURL = "https://de.wikipedia.org/wiki/Inkrement_und_Dekrement";
Blockly.Msg.MATH_DECREMENT_TITLE = "Verringere %1 um %2";
Blockly.Msg.MATH_DECREMENT_TOOLTIP = "Subtrahiert einen Wert von der Variable \"%1\" hinzu.";
...
Blockly.Msg.ARD_FUN_RUN_LOOP = "Wiederhole für immer :";
Blockly.Msg.ARD_FUN_RUN_SETUP = "Mache zuerst:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Definiere die OXOcard setup() und loop() Funktionen";
...
Blockly.Msg.ARD_TIME_DELAY_TIP = "Warte angegebene anzahl an Millisekunden";
...
Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIMEOUT_FIELD = "mit Timeout";
Blockly.Msg.OXOCARD_AUTO_TURNOFF_TIP = "Schaltet nach der angegebenen Zeit automatisch aus";
Blockly.Msg.OXOCARD_AUTO_TURNOFF_TITLE = "Automatisch ausschalten";
Blockly.Msg.OXOCARD_AUTO_TURNOFF_WP_TIP = "Die OXOcard schaltet nach 2 Minuten automatisch aus";
Blockly.Msg.OXOCARD_AUTO_TURNOFF_WP_TITLE = "Automatisch ausschalten";
Blockly.Msg.OXOCARD_BUTTON_PRESSED_LEFT_FIELD = "Links";
Blockly.Msg.OXOCARD_BUTTON_PRESSED_MIDDLE_FIELD = "Mitte";
Blockly.Msg.OXOCARD_BUTTON_PRESSED_RIGHT_FIELD = "Rechts";
Blockly.Msg.OXOCARD_BUTTON_PRESSED_TIP = "Ja, wenn der angegebene Knopf gedrückt ist";
Blockly.Msg.OXOCARD_BUTTON_PRESSED_TITLE = "Ist Knopf gedrückt?";
Blockly.Msg.OXOCARD_CLEAR_DISPLAY_TIP = "Schaltet das ganze Display aus";
Blockly.Msg.OXOCARD_CLEAR_DISPLAY_TITLE = "Lösche Display";
Blockly.Msg.OXOCARD_DRAW_CHAR_TIP = "Zeichnet ein einzelner Buchstabe (A - Z)";
Blockly.Msg.OXOCARD_DRAW_CHAR_TITLE = "Zeichne Buchstabe";
Blockly.Msg.OXOCARD_DRAW_CIRCLE_TIP = "Zeichnet ein Kreis";
Blockly.Msg.OXOCARD_DRAW_CIRCLE_TITLE = "Zeichne Kreis";
Blockly.Msg.OXOCARD_DRAW_DIGIT_TIP = "Zeichnet eine einzelne Ziffer (0 - 9)";
Blockly.Msg.OXOCARD_DRAW_DIGIT_TITLE = "Zeichne Ziffer";
Blockly.Msg.OXOCARD_DRAW_FILLED_CIRCLE_TIP = "Zeichnet einen gefüllten Kreis";
Blockly.Msg.OXOCARD_DRAW_FILLED_CIRCLE_TITLE = "Zeichne gefüllten Kreis";
Blockly.Msg.OXOCARD_DRAW_FILLED_RECTANGLE_TIP = "Zeichnet ein gefülltes Rechteck";
Blockly.Msg.OXOCARD_DRAW_FILLED_RECTANGLE_TITLE = "Zeichne gefülltes Rechteck";
Blockly.Msg.OXOCARD_DRAW_FILLED_TRANGLE_TIP = "Zeichnet ein gefülltes Dreieck";
Blockly.Msg.OXOCARD_DRAW_FILLED_TRANGLE_TITLE = "Zeichne gefülltes Dreieck";
Blockly.Msg.OXOCARD_DRAW_IMAGE_BRIGHTNESS_FIELD = "Helligkeit:";
Blockly.Msg.OXOCARD_DRAW_IMAGE_TIP = "Schaltet die angegebenen Pixel an";
Blockly.Msg.OXOCARD_DRAW_IMAGE_TITLE = "Zeichne Bild";
Blockly.Msg.OXOCARD_DRAW_LINE_TIP = "Zeichne eine Linie von X1, Y1 nach X2, Y2";
Blockly.Msg.OXOCARD_DRAW_LINE_TITLE = "Zeichne Linie";
Blockly.Msg.OXOCARD_DRAW_NUMBER_TIP = "Zeichnet eine Nummer (0 - 99)";
Blockly.Msg.OXOCARD_DRAW_NUMBER_TITLE = "Zeichne Nummer";
Blockly.Msg.OXOCARD_DRAW_PIXEL_TIP = "Schaltet das angegebene Pixel ein";
Blockly.Msg.OXOCARD_DRAW_PIXEL_TITLE = "Zeichne Pixel";
Blockly.Msg.OXOCARD_DRAW_RECTANGLE_TIP = "Zeichnet eine Rechteck";
Blockly.Msg.OXOCARD_DRAW_RECTANGLE_TITLE = "Zeichne Rechteck";
Blockly.Msg.OXOCARD_DRAW_TRANGLE_TIP = "Zeichnet ein Dreieck";
Blockly.Msg.OXOCARD_DRAW_TRANGLE_TITLE = "Zeichne Dreieck";
Blockly.Msg.OXOCARD_FILL_DISPLAY_TIP = "Schaltet das ganze Display an (Helligkeit 0 - 255)";
Blockly.Msg.OXOCARD_FILL_DISPLAY_TITLE = "Fülle Display";
Blockly.Msg.OXOCARD_FIND_IBEACON_TIP = "Sucht nach iBeacons mit der angegebenen ID";
Blockly.Msg.OXOCARD_FIND_IBEACON_TITLE = "Finde iBeacon mit ID";
Blockly.Msg.OXOCARD_GET_ACCELERATION_TIP = "Gibt die Beschleunigung der angegebenen Achse zurück";
Blockly.Msg.OXOCARD_GET_ACCELERATION_TITLE = "Beschleunigung";
Blockly.Msg.OXOCARD_GET_ORIENTATION_TIP = "Gibt die Orientierung der OXOcard zurück";
Blockly.Msg.OXOCARD_GET_ORIENTATION_TITLE = "Orientierung ";
Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TIP = "Liefert die Sekunden des Timers zurück";
Blockly.Msg.OXOCARD_GET_TIMER_SECONDS_TITLE = "Hole Timer Sekunden";
Blockly.Msg.OXOCARD_IS_ORIENTATION_DOWN_FIELD = "Ab";
Blockly.Msg.OXOCARD_IS_ORIENTATION_HORIZONTALLY_FIELD = "Horizontal";
Blockly.Msg.OXOCARD_IS_ORIENTATION_TIP = "Ja, wenn die OXOcard in der angegebenen Orientierung liegt";
Blockly.Msg.OXOCARD_IS_ORIENTATION_TITLE = "Ist Orientierung";
Blockly.Msg.OXOCARD_IS_ORIENTATION_UP_FIELD = "Auf";
Blockly.Msg.OXOCARD_IS_ORIENTATION_VERTICALLY_FIELD = "Vertikal";
Blockly.Msg.OXOCARD_NO_TONE_TIP = "Stoppt den Ton";
Blockly.Msg.OXOCARD_NO_TONE_TITLE = "Stoppe Ton";
Blockly.Msg.OXOCARD_PRINTLN_TIP = "Schreibt die angegebene Nummer oder Text in die Konsole (mit einem Zeilenumbruch)";
Blockly.Msg.OXOCARD_PRINTLN_TITLE = "Schreibe Zeile";
Blockly.Msg.OXOCARD_PRINT_TIP = "Schreibt die angegebene Nummer oder Text in die Konsole";
Blockly.Msg.OXOCARD_PRINT_TITLE = "Schreibe";
Blockly.Msg.OXOCARD_RANDOM_TIP = "Liefert eine zufällige Zahl zwischen 0 und dem angegebenen Wert";
Blockly.Msg.OXOCARD_RANDOM_TITLE = "Zufallszahl 0 bis ";
Blockly.Msg.OXOCARD_RESET_OXOCARD_TIP = "Startet die OXOcard neu";
Blockly.Msg.OXOCARD_RESET_OXOCARD_TITLE = "OXOcard neu starten";
Blockly.Msg.OXOCARD_RESET_TIMER_TIP = "Startet den Timer neu";
Blockly.Msg.OXOCARD_RESET_TIMER_TITLE = "Timer zurücksetzen";
Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_ID_FIELD = "mit der ID";
Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_TIP = "Startet die OXOcard als iBeacon mit der angegebenen ID";
Blockly.Msg.OXOCARD_SETUP_AS_IBEACON_TITLE = "Starte als iBeacon";
Blockly.Msg.OXOCARD_SMILE_TIP = "Zeichnet ein einfaches Smile :)";
Blockly.Msg.OXOCARD_SMILE_TITLE = "Zeichne Smile :)";
Blockly.Msg.OXOCARD_TONE_DURATION_FIELD = "für die Dauer";
Blockly.Msg.OXOCARD_TONE_FREQUENCY_FIELD = "mit Frequenz";
Blockly.Msg.OXOCARD_TONE_NO_DURATION_TIP = "Spielt einen ton ab";
Blockly.Msg.OXOCARD_TONE_NO_DURATION_TITLE = "Spiele Ton";
Blockly.Msg.OXOCARD_TONE_TIP = "Spelt ein Ton für die angegebene Zeit";
Blockly.Msg.OXOCARD_TONE_TITLE = "Spiele Ton";
Blockly.Msg.OXOCARD_TURN_DISPLAY_ON_TIP = "Schaltet das ganze Display an";
Blockly.Msg.OXOCARD_TURN_DISPLAY_ON_TITLE = "Schalte Display an";
Blockly.Msg.OXOCARD_TURN_OXOCARD_OFF_TIP = "Schaltet die OXOcard aus";
Blockly.Msg.OXOCARD_TURN_OXOCARD_OFF_TITLE = "OXOcard ausschalten";
Blockly.Msg.OXOCARD_WINK_TIP = "Zeichnet ein einfaches zwinkersmiley ;)";
Blockly.Msg.OXOCARD_WINK_TITLE = "Zeichne Zwinkersmiley ;)";
